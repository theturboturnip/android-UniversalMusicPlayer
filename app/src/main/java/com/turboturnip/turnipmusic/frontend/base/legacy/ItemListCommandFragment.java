...
@Deprecated
public abstract class ItemListCommandFragment extends BaseCommandFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.legacy_fragment_list, container, false);
	...
	protected Drawable getDrawableFromListItemState(ListItemData data, int itemState){
		return null;
	}
	private View getListItemView(ListItemData item, View itemView, @NonNull ViewGroup parent){
		...
		if (cachedState == STATE_INVALID || cachedState != newState){
			Drawable drawable = getDrawableFromListItemState(item, newState);
			if (drawable == null)
				cachedViews.actionButtonView.setVisibility(View.GONE);
			else {
				cachedViews.actionButtonView.setVisibility(View.VISIBLE);
				cachedViews.actionImageView.setImageDrawable(drawable);
			}
	...
	private class ListItemCachedViews {
		...
		final View actionButtonView;
		final ImageView dataImageView;
		...
		ListItemCachedViews(View itemView){
			...
			actionButtonView = itemView.findViewById(R.id.into_button);
			dataImageView = itemView.findViewById(R.id.action_drawable);
			actionImageView = itemView.findViewById(R.id.into_drawable);
	...
	public static class ListItemData {
		...
		public View.OnClickListener onActioned = null;
		...
		public ListItemData(CharSequence title, CharSequence subtitle, View.OnClickListener onActioned, ActionType actionType){
			this.title = title;
			this.subtitle = subtitle;

			this.onActioned = onActioned;
		...
		void applyToViews(ListItemCachedViews views){
			...
			views.actionButtonView.setVisibility(View.VISIBLE);
			views.actionButtonView.setOnClickListener(onActioned);
		}
	}
